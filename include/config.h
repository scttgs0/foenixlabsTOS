...
/*
 * Defaults for the A2560M from Foenix Retro Systems
 */
#ifdef MACHINE_A2560M
# ifndef MACHINE_A2560_DEBUG
#  define MACHINE_A2560_DEBUG 1
# endif
# ifndef FOENIX_CHANNEL_A_DEBUG_PRINT
...
/* Determine if kprintf() is available */
   ...
   CONSOLE_DEBUG_PRINT || RS232_DEBUG_PRINT || SCC_DEBUG_PRINT || COLDFIRE_DEBUG_PRINT || \
   MIDI_DEBUG_PRINT || CARTRIDGE_DEBUG_PRINT || FOENIX_CHANNEL_A_DEBUG_PRINT || (defined(MACHINE_A2560M) && FOENIX_COM3_DEBUG_PRINT)
...
/*
 * Use the USB-based UART for debug output
 */
# ifndef FOENIX_COM3_DEBUG_PRINT
#  define FOENIX_COM3_DEBUG_PRINT 0
# endif
